...
Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . "/css/certificates.css");
Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/js/certificates.js");
?>
...
<div id="certificate-modal" class="modal certificates-modal">
    <div class="modal-content">
        <span class="close-modal">&times;</span>
        <div class="modal-certificate">
            <img id="modal-cert-image" src="" alt="Просмотр сертификата">
