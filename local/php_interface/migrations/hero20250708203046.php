...
class hero20250708203046 extends Version
{
  ...
  array (
    ...
    'ACTIVE' => 'Активность',
    'NAME' => 'Имя',
    'PREVIEW_TEXT' => 'Текст под именем',
    'DETAIL_TEXT' => 'Описание',
    'IBLOCK_ELEMENT_PROP_VALUE' => 'Значения свойств',
    'PROPERTY_PHOTOS' => 'Фотографии',
    'PROPERTY_CONTACT_BTN' => 'Текст кнопки "Связаться"',
    'PROPERTY_SECOND_BTN' => 'Вторая кнопка',
    'PROPERTY_TECH_ICONS' => 'Иконки технологий',
    'PROPERTY_BACK_PHOTOS' => 'Фоновые картинки',
  ),
  'Анонс|edit5' => 
  array (
  ),
